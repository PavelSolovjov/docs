...
description: "Настройка Windsurf для вашей документации"
icon: "water"
---

Настройте ИИ-ассистента Cascade в Windsurf, чтобы он помогал писать и поддерживать документацию. В этом руководстве показано, как подготовить Windsurf именно для работы с документацией в Mintlify.
...
Создайте правила рабочего пространства, которые дадут Windsurf контекст о вашем проекте документации и внутренних стандартах.

Создайте файл `.windsurf/rules.md` в корне проекта:
