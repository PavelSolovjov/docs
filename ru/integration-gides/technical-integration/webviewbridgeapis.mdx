---
title: "WebView Bridge APIs"
description: "Technical documentation for JavaScript bridge APIs that must be injected into WebView for integration with the Holders web application."
---
...
**Important:** All examples in this documentation use the Tonnub mobile wallet as a reference. After deploying the corresponding environments by the Holders team, it is necessary to adapt the paths and names according to your wallet's naming.
...
| API               | Priority    | Necessity                                              |
| :---------------- | :---------- | :----------------------------------------------------- |
| TonConnect Bridge | 🔴 Critical | Connection and transactions                            |
| Main Button API   | 🔴 High     | Action button                                          |
| DApp Client API   | 🔴 High     | Closing and navigation (minimum `closeApp`, `openUrl`) |
| Auth API          | 🔴 High     | Operation security                                     |
| Status Bar API    | 🟡 Medium   | Safe area insets                                       |
| Toaster API       | 🟡 Medium   | User notifications                                     |
| Wallet API        | 🟡 Medium   | Only for Apple/Google Pay cards                        |
| Emitter API       | 🟡 Medium   | State synchronization                                  |
| Support API       | 🟢 Low      | Intercom (Optional)                                    |
