...
You can find a detailed description of the Injected bridge and all its APIs on the [WebView Bridge APIs](/inegration-gides/web-view-bridge-apis) page.

# URL parameters

When loading the Holders WebApp, you need to pass the following query parameters:
...
WebView can control the native application via URL parameters:
