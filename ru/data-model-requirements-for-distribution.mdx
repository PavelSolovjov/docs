---
title: "Data Model Requirements for Distribution"
---

New fields needed on `merchants` table:
...
New fields needed on `fee_tiers` table (or a separate `distribution_tiers` table):
...
New table — `merchant_settlements`:
