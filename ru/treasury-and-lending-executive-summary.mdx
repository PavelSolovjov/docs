...
| Процентная ставка | Fixed или floating, например SOFR / EURIBOR \+ spread |
...
| Maturity match | Использовать линию, срок действия которой перекрывает settlement period merchant | Чтобы избежать maturity mismatch |
