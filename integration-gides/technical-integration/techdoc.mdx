...
description: "This guide is intended for implementing the technical Holders WebView integration into the partner’s product."
---
...
\*Instead of yourwallet - URLs with your wallet name will be implemented.
...
For authentication, the [TonConnect v2](https://github.com/ton-connect) protocol is used. It is necessary to create proof (proof of wallet ownership) for TON and optionally for Solana.
