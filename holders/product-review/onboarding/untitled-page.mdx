...
description: "This document explains what onboarding in Holders is, its goals, when it starts and ends, the main user steps, and how wallet connection and user token creation technically work."
---
