...
8. The user proceeds to the product selection page, where they are given the opportunity to choose one of three available products. After confirming their choice, the user awaits account issuance.
   ...
   <img
     ...
     style={{ width:"31%" }}
   />
9. The user arrives at the account page and waits for the smart contract deployment to complete. After deployment finishes, the user sees a modal window with an offer to fund their account. The modal window will appear each time the user navigates to the account page until the first funding is completed.
